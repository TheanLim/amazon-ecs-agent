...
func TestInvalidInstanceException(t *testing.T) {
	...
	err := acsErr.NewError(&types.InvalidInstanceException{Message_: &errMsg})
...
func TestInvalidClusterException(t *testing.T) {
	...
	err := acsErr.NewError(&types.InvalidClusterException{Message_: &errMsg})
...
func TestServerException(t *testing.T) {
	err := acsErr.NewError(&types.ServerException{Message_: nil})
